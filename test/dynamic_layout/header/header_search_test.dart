...
void main() {
  ...
  testWidgets('HeaderSearch background color test',
    ...
    final bgColorWidget = tester
        .widget<BackgroundColorWidget>(find.byType(BackgroundColorWidget));
  ...
  testWidgets('HeaderSearch useGradiantBG test', (WidgetTester tester) async {
    ...
    final backgroundColorWidget =
        find.byType(BackgroundColorWidget).first.evaluate().single.widget;
