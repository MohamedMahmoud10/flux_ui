...
void main() {
  group('Tools', () {
    ...
    test('calculateDistance should return the correct distance', () {
      final distance =
          Tools.calculateDistance(40.7128, -74.0060, 34.0522, -118.2437);
    ...
    test('getAlignment should return the correct AlignmentGeometry', () {
      ...
      expect(
          Tools.getAlignment('bottomLeft'), AlignmentDirectional.bottomStart);
  ...
  test('getFileNameFromUrl should return the file name from a URL', () {
    expect(
        Tools.getFileNameFromUrl('https://example.com/image.jpg'), 'image.jpg');
    expect(Tools.getFileNameFromUrl('https://example.com/document.pdf'),
        'document.pdf');
    expect(Tools.getFileNameFromUrl('https://example.com/'),
        'https://example.com/');
  });
  ...
  test('launchURL should throw an exception if the URL is invalid', () async {
    ...
    expect(() async => await Tools.launchURL(invalidUrl),
