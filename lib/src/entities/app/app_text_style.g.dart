...
_$AppTextStyleImpl _$$AppTextStyleImplFromJson(Map<String, dynamic> json) =>
    _$AppTextStyleImpl(
      ...
      shadows: const ShadowsConverter()
          .fromJson(json['shadows'] as List<Map<String, dynamic>>?),
      decoration: const TextDecorationConverter()
          .fromJson(json['decoration'] as String?),
