...
@freezed
class ItemSizeAdvanceConfig with _$ItemSizeAdvanceConfig {
  ...
  factory ItemSizeAdvanceConfig.fixed(double value) => ItemSizeAdvanceConfig(
        value: value,
        type: ItemSizeAdvanceType.fixed,
      );
