...
_$ListCardConfigImpl _$$ListCardConfigImplFromJson(Map<String, dynamic> json) =>
    _$ListCardConfigImpl(
      ...
      padding: const EdgeInsetsDirectionalConverter()
          .fromJson(json['padding'] as Map<String, dynamic>?),
      style: $enumDecodeNullable(_$ListCardStyleEnumMap, json['style']) ??
          ListCardStyle.titleHeading,
      itemInLine: (json['itemInLine'] as num?)?.toDouble(),
      itemSpacing: (json['itemSpacing'] as num?)?.toDouble(),
      divider: const DividerConverter()
          .fromJson(json['divider'] as Map<String, dynamic>?),
    );
...
Map<String, dynamic> _$$ListCardConfigImplToJson(
    ...
    <String, dynamic>{
      ...
      'axis': _$JsonConverterToJson<String?, Axis>(
          instance.axis, const AxisConverter().toJson),
      'imageBoxStyle': instance.imageBoxStyle?.toJson(),
      'contentPadding': const EdgeInsetsDirectionalConverter()
          .toJson(instance.contentPadding),
      'padding':
          const EdgeInsetsDirectionalConverter().toJson(instance.padding),
