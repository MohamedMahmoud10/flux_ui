...
class SliderListConfig {
  ...
  factory SliderListConfig.fromJson(dynamic json) {
    var limitIndicator =
        num.tryParse(json['limitIndicator'].toString())?.toInt();
    ...
    return SliderListConfig(
      ...
      pageIndicatorType:
          PageIndicatorType.fromString(json['pageIndicatorType']),
      paddingContent: Helper.formatDouble(json['paddingContent']),
      borderRadiusTag: Helper.formatDouble(json['borderRadiusTag']) ?? 5.0,
      borderRadius: Helper.formatDouble(json['borderRadius']) ?? 3.0,
      autoPlay: json['autoPlay'] ?? false,
      secondsAutoSliding:
          num.tryParse(json['secondsAutoSliding'].toString())?.toInt(),
