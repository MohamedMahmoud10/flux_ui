...
_$FluxCardConfigImpl _$$FluxCardConfigImplFromJson(Map<String, dynamic> json) =>
    _$FluxCardConfigImpl(
      ...
      surfaceTintColor:
          const ColorConverter().fromJson(json['surfaceTintColor']),
      ...
      borderSide: json['borderSide'] == null
          ...
          : const BorderSideConverter()
              .fromJson(json['borderSide'] as Map<String, dynamic>?),
      clipBehavior:
          const ClipConverter().fromJson(json['clipBehavior'] as String?),
      margin: const EdgeInsetsDirectionalConverter()
          .fromJson(json['margin'] as Map<String, dynamic>?),
      contentPadding: const EdgeInsetsDirectionalConverter()
...
Map<String, dynamic> _$$FluxCardConfigImplToJson(
    ...
    <String, dynamic>{
      ...
      'surfaceTintColor':
          const ColorConverter().toJson(instance.surfaceTintColor),
      'elevation': instance.elevation,
      'borderRadius': const BorderRadiusDirectionalConverter()
          .toJson(instance.borderRadius),
      ...
      'contentPadding': const EdgeInsetsDirectionalConverter()
          .toJson(instance.contentPadding),
    };
