...
class ListCardWidget extends StatelessWidget {
  ...
  Widget _buildSeparator(bool isHorizontal) {
    ...
    if (divider != null) {
      ...
      final height = (config.heightContent ?? 0) +
  ...
  Widget _buildCard(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: ClipRRect(
          borderRadius: config.cardBoxStyle?.decoration?.borderRadius ??
              BorderRadius.zero,
          child: Column(
  ...
  TextStyle? _getSubtitleStyle(BuildContext context) {
    ...
    return ThemeHelper.getFont(
      ...
      textStyle:
          Theme.of(context).textTheme.bodySmall?.merge(itemSubtitleStyle),
    );
  }
