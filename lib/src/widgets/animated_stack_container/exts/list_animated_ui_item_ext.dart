...
extension AnimatedPropertyListExtension on List<AnimatedUiItem> {
  ...
  List<AnimatedUiItem> sortPosition() {
    ...
    while (isMorePosition) {
      ...
      isMorePosition = listData
              .where((element) =>
                  element.script.startState is AnimatedPositionState)
              .length >
          1;
    }
    ...
    listData.sort((a, b) {
      final aIsPosition = a.script.startState is AnimatedPositionState ||
