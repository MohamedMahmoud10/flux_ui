...
extension BorderRadiusDirectionalExtension on BorderRadiusDirectional {
  static BorderRadiusDirectional fromJson(Map<String, dynamic> json) {
    return BorderRadiusDirectional.only(
      topStart:
          Radius.circular(json['topStart'].toString().tryParseDouble() ?? 0.0),
      topEnd:
          Radius.circular(json['topEnd'].toString().tryParseDouble() ?? 0.0),
      bottomStart: Radius.circular(
          json['bottomStart'].toString().tryParseDouble() ?? 0.0),
      bottomEnd:
          Radius.circular(json['bottomEnd'].toString().tryParseDouble() ?? 0.0),
    );
  }
