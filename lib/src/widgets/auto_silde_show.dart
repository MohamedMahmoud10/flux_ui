...
class _HandleAutoSlideForPageState extends State<HandleAutoSlideForPage> {
  Timer? _timer;
...
class _HandleAutoSlideForListState extends State<HandleAutoSlideForList> {
  ...
  @override
  void didUpdateWidget(covariant HandleAutoSlideForList oldWidget) {
